...
-- CreateEnum
CREATE TYPE "ScheduleStatus" AS ENUM ('ACTIVE', 'NON_ACTIVE', 'CANCELLED', 'DELAYED');
...
-- CreateIndex
CREATE INDEX "route_stations_routeId_idx" ON "route_stations"("routeId");

-- CreateIndex
CREATE INDEX "route_stations_stationId_idx" ON "route_stations"("stationId");

-- CreateIndex
CREATE UNIQUE INDEX "route_stations_routeId_stationId_key" ON "route_stations"("routeId", "stationId");

-- CreateIndex
CREATE INDEX "schedules_trainId_idx" ON "schedules"("trainId");
